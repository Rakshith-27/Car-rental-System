              ...
              <div class="sidebar_widget">
                ...
                <form method="post">
                  <div class="form-group">
                    <input type="text" class="form-control" name="fromdate" placeholder="From Date(yyyy/mm/dd/)" required>
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" name="todate" placeholder="To Date(yyyy/mm/dd)" required>
                  </div>
                  <div class="form-group">
