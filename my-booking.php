...
<style>
        .qr-code {
            display: none; /* Hide the QR code image by default */
            position: fixed;
            top: 50%;
            left: 50%;
...
<li>
               ...
               <div class="vehicle_status">
                    <a href="#" class="btn outline btn-xs active-btn">Confirmed</a><br>
                      <div class="clearfix"></div>
                </div>

<div class="qr-code">
    <img src="assets\images\qr_code.jpg" alt="QR Code" width="250px" height="250px">
</div>
...
<script>
 ...
 <a href="#" class="btn outline btn-xs active-btn pay-now-btn">Pay Now</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
